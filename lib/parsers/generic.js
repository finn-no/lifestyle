...
function parseGeolocation(geoEle) {
    var parts = geoEle.textContent.split(' ');
    parts = parts.map(function(e) { return parseFloat(e); });
    return {
        lat: parts[0],
        lon: parts[1],
        accuracy: geoEle.getAttribute("finn:accuracy")
    };
}
